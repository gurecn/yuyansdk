...
public class SignatureView extends TextKeyboard {
	// View state
	...
	private int mMaxWidth = convertDpToPx(12.0f);
	private int mMinWidth = convertDpToPx(6.0f);

	private float mVelocityFilterWeight  = 0.7f;
	...
	public void setTheme(@NonNull Theme theme) {
		...
		mPaint.setColor(mActiveTheme.getKeyTextColor());
	}
