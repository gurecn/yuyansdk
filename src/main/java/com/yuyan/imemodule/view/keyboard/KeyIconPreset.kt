...
val keyIconRecords: Map<Int, Drawable?> = mapOf(
    Objects.hash(InputModeSwitcherManager.USERDEF_KEYCODE_SHIFT_1, 0) to ContextCompat.getDrawable(ImeSdkApplication.context, R.drawable.shift_off_icon),
    Objects.hash(InputModeSwitcherManager.USERDEF_KEYCODE_SHIFT_1, 1) to ContextCompat.getDrawable(ImeSdkApplication.context, R.drawable.shift_on_icon),
    Objects.hash(InputModeSwitcherManager.USERDEF_KEYCODE_SHIFT_1, 2) to ContextCompat.getDrawable(ImeSdkApplication.context, R.drawable.shift_lock_icon),
