...
val keyIconRecords: Map<Int, Drawable?> = mapOf(
    ...
    Objects.hash(KeyEvent.KEYCODE_DPAD_LEFT, 0) to ContextCompat.getDrawable(ImeSdkApplication.context, R.drawable.skb_key_cursor_left_icon),
    Objects.hash(KeyEvent.KEYCODE_DPAD_RIGHT, 0) to ContextCompat.getDrawable(ImeSdkApplication.context, R.drawable.skb_key_cursor_right_icon),
    Objects.hash(KeyEvent.KEYCODE_DPAD_UP, 0) to ContextCompat.getDrawable(ImeSdkApplication.context, R.drawable.skb_key_cursor_up_icon),
    Objects.hash(KeyEvent.KEYCODE_DPAD_DOWN, 0) to ContextCompat.getDrawable(ImeSdkApplication.context, R.drawable.skb_key_cursor_down_icon),
