...
val keyIconRecords: Map<Int, Drawable?> = mapOf(
    ...
    Objects.hash(InputModeSwitcherManager.USER_DEF_KEYCODE_LANG_2, 1) to ContextCompat.getDrawable(Launcher.instance.context, R.drawable.sdk_skb_key_input_mode_en2_icon),
    Objects.hash(InputModeSwitcherManager.USER_DEF_KEYCODE_LANG_2, 2) to ContextCompat.getDrawable(Launcher.instance.context, R.drawable.sdk_skb_key_input_mode_jp_icon),
