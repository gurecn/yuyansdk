...
object LX17PinYinUtils {
    ...
    init {
        ...
        lx17PinyinMap.put("QH", "Qa,qia")
        lx17PinyinMap.put("QS", "Qen,qin")
        lx17PinyinMap.put("QZ", "Qang,qiao")
        lx17PinyinMap.put("QB", "Qao,qiong")
        lx17PinyinMap.put("QX", "Qo,quan")
        lx17PinyinMap.put("QM", "qie")
        lx17PinyinMap.put("QL", "Qai,que")
        lx17PinyinMap.put("QD", "qu")
        lx17PinyinMap.put("QY", "Qeng,qing")
